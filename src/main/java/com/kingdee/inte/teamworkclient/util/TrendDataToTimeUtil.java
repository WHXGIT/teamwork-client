package com.kingdee.inte.teamworkclient.util;
...
public class TrendDataToTimeUtil {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(com.kingdee.inte.teamworkclient.util.TrendDataToTimeUtil.class);
